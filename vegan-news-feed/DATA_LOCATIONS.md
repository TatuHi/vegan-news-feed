...
| Send history — cross-day dedup, topic-balance tiebreaker, gap detection | `~/.config/vegan-news/sent_history.json` | Per-machine runtime state, not code; grows daily |
